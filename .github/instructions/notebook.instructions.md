---
description: Architecture documentation for ShadowCode notebook and interactive window components. Use when working in `src/vs/workbench/contrib/notebook/`
---

# Notebook Architecture

This document describes the internal architecture of ShadowCode's notebook implementation.
