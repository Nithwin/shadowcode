---
description: Architecture documentation for ShadowCode interactive window component. Use when working in `src/vs/workbench/contrib/interactive`
---

# Interactive Window

The interactive window component enables extensions to offer REPL like experience to its users. ShadowCode provides the user interface and extensions provide the execution environment, code completions, execution results rendering and so on.
