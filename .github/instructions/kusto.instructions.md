...
When performing Kusto queries, telemetry analysis, or data exploration tasks for ShadowCode, consult the comprehensive Kusto instructions located at:
...
- Available Kusto clusters and databases for ShadowCode telemetry
