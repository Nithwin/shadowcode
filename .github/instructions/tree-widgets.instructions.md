---
description: Use when asked to consume workbench tree widgets in ShadowCode.
---
...
The Workbench Tree Widgets provide high-level, workbench-integrated tree components that extend the base tree implementations with ShadowCode-specific functionality like context menus, keyboard navigation, theming, accessibility, and dependency injection integration. These widgets serve as the primary tree components used throughout the ShadowCode workbench for file explorers, debug views, search results, and other hierarchical data presentations.

## Scope

### Included Functionality
- **Context Integration**: Automatic context key management, focus handling, and ShadowCode theme integration
...
- **Dependency Injection**: Full integration with ShadowCode's service container for automatic service injection
