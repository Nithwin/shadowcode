---
name: hygiene
description: Use when making code changes to ensure they pass ShadowCode's hygiene checks. Covers the pre-commit hook, unicode restrictions, string quoting rules, copyright headers, indentation, formatting, ESLint, and stylelint. Run the hygiene check before declaring work complete.
---

# Hygiene Checks

ShadowCode runs a hygiene check as a git pre-commit hook. Commits will be rejected if hygiene fails.
