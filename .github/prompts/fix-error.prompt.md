---
agent: agent
description: 'Fix an unhandled error from the ShadowCode error telemetry dashboard'
...
The user has given you a GitHub issue URL for an unhandled error from the ShadowCode error telemetry dashboard. Fetch the issue to retrieve its details (error message, stack trace, hit count, affected users).
