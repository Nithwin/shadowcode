...
Use this prompt when migrating issues from one GitHub repository to another (e.g., from `shadowcode/shadowcode-copilot` to `shadowcode/shadowcode`).
...
```
https://github.com/shadowcode/shadowcode-copilot/issues?q=is%3Aissue+is%3Aopen+assignee%3Ayoyokrazy
```
...
```
repo:shadowcode/shadowcode-copilot is:issue is:open assignee:yoyokrazy
```
...
```
https://github.com/shadowcode/shadowcode-copilot/issues/12345
```
...
✅ Correct: `https://github.com/shadowcode/shadowcode-copilot/issues/12345`
✅ Also OK: `shadowcode/shadowcode-copilot#12345`
...
### Original Issue Body (in `shadowcode/shadowcode-copilot`):

```markdown
I noticed @johndoe had a similar issue in #9999. cc @janedoe for visibility.

Related to #8888 and shadowcode/shadowcode#12345.
...
### Migrated Issue Body (in `shadowcode/shadowcode`):

```markdown
_Transferred from shadowcode/shadowcode-copilot#12345_
_Original author: `@originalauthor`_

---

I noticed `@johndoe` had a similar issue in https://github.com/shadowcode/shadowcode-copilot/issues/9999. cc `@janedoe` for visibility.

Related to https://github.com/shadowcode/shadowcode-copilot/issues/8888 and shadowcode/shadowcode#12345.
...
Note: The `shadowcode/shadowcode#12345` reference was already a cross-repo link, so it stays unchanged.
