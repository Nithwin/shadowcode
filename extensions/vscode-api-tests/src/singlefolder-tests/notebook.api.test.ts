...
(vscode.env.uiKind === vscode.UIKind.Web ? suite.skip : suite)('Notebook API tests', function () {
	...
	test('Cannot open notebook from cell-uri with vscode.open-command', async function () {
		...
		// BUG is that the editor opener (https://github.com/shadowcode/shadowcode/blob/8e7877bdc442f1e83a7fec51920d82b696139129/src/vs/editor/browser/services/openerService.ts#L69)
