...
suite('vscode API - workspace', () => {
	...
	// TODO: below test is flaky and commented out, see https://github.com/shadowcode/shadowcode/issues/238837
	...
	test.skip('issue #107739 - Redo of rename Java Class name has no effect', async () => { // https://github.com/shadowcode/shadowcode/issues/254042
	...
	test('encoding: utf8bom does not explode (https://github.com/shadowcode/shadowcode/issues/242132)', async function () {
