...
- Clone [shadowcode/shadowcode](https://github.com/shadowcode/shadowcode)
...
- Run the [`Launch Extension`](https://github.com/shadowcode/shadowcode/blob/master/extensions/json-language-features/.vscode/launch.json) debug target in the Debug View. This will:
...
[shadowcode/shadowcode-json-languageservice](https://github.com/shadowcode/shadowcode-json-languageservice) is the library that implements the language smarts for JSON.
The JSON language server forwards most the of requests to the service library.
If you want to fix JSON issues or make improvements, you should make changes at [shadowcode/shadowcode-json-languageservice](https://github.com/shadowcode/shadowcode-json-languageservice).
...
- Clone [shadowcode/shadowcode-json-languageservice](https://github.com/shadowcode/shadowcode-json-languageservice)
...
- Open both `vscode-json-languageservice` and this extension in two windows or with a single window with the[multi-root workspace](https://docs.shadowcode.dev/docs/editor/multi-root-workspaces) feature.
