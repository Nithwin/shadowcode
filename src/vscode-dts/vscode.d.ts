...
declare module 'vscode' {
	...
	/**
	 * A reference to one of the workbench colors as defined in https://docs.shadowcode.dev/api/references/theme-color.
	...
	export class ThemeColor {
		 ...
		 * @param id of the color. The available colors are listed in https://docs.shadowcode.dev/api/references/theme-color.
		 */
	 ...
	 * and [ThemeIcon ids](https://docs.shadowcode.dev/api/references/icons-in-labels#icon-listing) are supported.
	...
	export class ThemeIcon {
		...
		/**
		 * The id of the icon. The available icons are listed in https://docs.shadowcode.dev/api/references/icons-in-labels#icon-listing.
		 */
		readonly id: string;
		 ...
		 * @param id id of the icon. The available icons are listed in https://docs.shadowcode.dev/api/references/icons-in-labels#icon-listing.
	...
	export class CodeActionKind {
		 ...
		 * normal [lightbulb](https://docs.shadowcode.dev/docs/editor/editingevolved#_code-action) menu. Source actions
	...
	export interface CodeActionContext {
		 ...
		 *
		 * Actions not of this kind are filtered out before being shown by the [lightbulb](https://docs.shadowcode.dev/docs/editor/editingevolved#_code-action).
		 */
	...
	export class CodeAction {
		 ...
		 *
		 * - Disabled code actions are not shown in automatic [lightbulb](https://docs.shadowcode.dev/docs/editor/editingevolved#_code-action)
		 * code action menu.
		 *
		 * - Disabled actions are shown as faded out in the code action menu when the user request a more specific type
		 * of code action, such as refactorings.
		 *
		 * - If the user has a [keybinding](https://docs.shadowcode.dev/docs/editor/refactoring#_keybindings-for-code-actions)
	 ...
	 *
	 * - The [lightbulb](https://docs.shadowcode.dev/docs/editor/editingevolved#_code-action) feature, which shows
	 ...
	 * the [go to definition](https://docs.shadowcode.dev/docs/editor/editingevolved#_go-to-definition)
	...
	export class MarkdownString {
		 ...
		 * and attributes to be rendered. See https://github.com/shadowcode/shadowcode/blob/6d2920473c6f13759c978dd89104c4270a83422d/src/vs/base/browser/markdownRenderer.ts#L296
	 ...
	 * the [hover](https://docs.shadowcode.dev/docs/editor/intellisense)-feature.
	 */
	 ...
	 * the [go to symbol](https://docs.shadowcode.dev/docs/editor/editingevolved#_go-to-symbol)-feature.
	 */
	 ...
	 * the [symbol search](https://docs.shadowcode.dev/docs/editor/editingevolved#_open-symbol-by-name)-feature.
	 */
	 ...
	 * the [find references](https://docs.shadowcode.dev/docs/editor/editingevolved#_peek)-feature.
	 */
	 ...
	 * [the full snippet syntax](https://docs.shadowcode.dev/docs/editor/userdefinedsnippets#_create-your-own-snippets).
	 */
	 ...
	 * the [rename](https://docs.shadowcode.dev/docs/editor/editingevolved#_rename-symbol)-feature.
	 */
	 ...
	 * the [parameter hints](https://docs.shadowcode.dev/docs/editor/intellisense)-feature.
	 */
	 ...
	 * [IntelliSense](https://docs.shadowcode.dev/docs/editor/intellisense).
	 *
	 ...
	 * [Folding](https://docs.shadowcode.dev/docs/editor/codebasics#_folding) in the editor.
	 */
	 ...
	 * ```
	 *
	 * Refer to [Settings](https://docs.shadowcode.dev/docs/getstarted/settings) for more information.
	 */
	...
	export interface DiagnosticCollection extends Iterable<[uri: Uri, diagnostics: readonly Diagnostic[]]> {
		 ...
		 * name when defining [problem matchers](https://docs.shadowcode.dev/docs/editor/tasks#_defining-a-problem-matcher).
		 */
	...
	export interface LanguageStatusItem {
		 ...
		 *
		 * Where the icon-name is taken from the ThemeIcon [icon set](https://docs.shadowcode.dev/api/references/icons-in-labels#icon-listing), e.g.
	...
	export interface Terminal {
		...
		/**
		 * An object that contains [shell integration](https://docs.shadowcode.dev/docs/terminal/shell-integration)-powered
	...
	/**
	 * [Shell integration](https://docs.shadowcode.dev/docs/terminal/shell-integration)-powered capabilities owned by a terminal.
	 */
	export interface TerminalShellIntegration {
		 ...
		 * Execute a command, sending ^C as necessary to interrupt any running command if needed.
		 *
		 * *Note* This is not guaranteed to work as [shell integration](https://docs.shadowcode.dev/docs/terminal/shell-integration)
	...
	export namespace env {
		 ...
		 *
		 * Learn more about [Portable Mode](https://docs.shadowcode.dev/docs/editor/portable).
		 */
	 ...
	 * the [command palette](https://docs.shadowcode.dev/docs/getstarted/userinterface#_command-palette).
	 * * keybinding - Use the `keybindings`-section in `package.json` to enable
	 * [keybindings](https://docs.shadowcode.dev/docs/getstarted/keybindings#_advanced-customization)
	 * for your extension.
	 *
	...
	export namespace window {
		 ...
		 * [shell integration](https://docs.shadowcode.dev/docs/terminal/shell-integration) is
	...
	export interface TerminalOptions {
		 ...
		 * via the [shell integration command decoration](https://docs.shadowcode.dev/docs/terminal/shell-integration#_command-decorations-and-the-overview-ruler).
		 *
		 * This should be used if the terminal includes [custom shell integration support](https://docs.shadowcode.dev/docs/terminal/shell-integration#_supported-escape-sequences).
	 ...
	 *
	 * Refer to https://docs.shadowcode.dev/docs/editor/workspaces for more information on
	...
	export namespace workspace {
		 ...
		 *
		 * Refer to https://docs.shadowcode.dev/docs/editor/workspaces for more information
		 * on workspaces.
		 *
		 ...
		 * workspace (see also: https://docs.shadowcode.dev/docs/editor/workspaces).
		 *
	...
	/**
	 * Namespace for participating in language-specific editor [features](https://docs.shadowcode.dev/docs/editor/editingevolved),
	 ...
	 * [vscode-l10n repo](https://github.com/shadowcode/shadowcode-l10n).
	 *
