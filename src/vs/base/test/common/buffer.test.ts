...
suite('Buffer', () => {
	...
	test('Performance issue with VSBuffer#slice #76076', function () { // TODO@alexdima this test seems to fail in web (https://github.com/shadowcode/shadowcode/issues/114042)
