...
suite('Filters', () => {
	...
	test('PrefixFilter - ignore case', function () {
		...
		filterNotOk(matchesPrefix, 'T', '4'); // see https://github.com/shadowcode/shadowcode/issues/22401
	});
	...
	test('Freeze when fjfj -> jfjf, https://github.com/shadowcode/shadowcode/issues/91807', function () {
		assertMatches(
			'jfjfj',
	...
	test('configurable full match boost', function () {
		...
		// also works with wordStart > 0 (https://github.com/shadowcode/shadowcode/issues/187921)
