...
export abstract class Pane extends Disposable implements IView {
	...
	render(): void {
		...
		// Use role button so the aria-expanded state gets read https://github.com/shadowcode/shadowcode/issues/95996
...
class PaneDraggable extends Disposable {
	...
	private dragOverCounter = 0; // see https://github.com/shadowcode/shadowcode/issues/14470
