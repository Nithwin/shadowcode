		...
		while (true) {
			...
			if (!didChange) {
				...
				if (typeof anchorElementIndex === 'number') {
					...
					// See https://github.com/shadowcode/shadowcode/issues/104144
					// See https://github.com/shadowcode/shadowcode/pull/104284
					// See https://github.com/shadowcode/shadowcode/issues/107704
