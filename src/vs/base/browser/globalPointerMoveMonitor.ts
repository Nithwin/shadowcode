		...
		try {
			...
			this._hooks.add(toDisposable(() => {
				try {
					...
					// See https://github.com/shadowcode/shadowcode/issues/161731
					//
			...
			// See https://github.com/shadowcode/shadowcode/issues/144584
			// See https://github.com/shadowcode/shadowcode/issues/146947
