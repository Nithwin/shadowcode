...
export const EditorOptions = {
	...
	multiCursorModifier: register(new EditorEnumOption(
		...
		_multiCursorModifierFromString,
		{
			...
			}, "The modifier to be used to add multiple cursors with the mouse. The Go to Definition and Open Link mouse gestures will adapt such that they do not conflict with the [multicursor modifier](https://docs.shadowcode.dev/docs/editor/codebasics#_multicursor-modifier).")
		}
	)),
