...
export class TextAreaInput extends Disposable {
	...
	constructor(
		...
		this._register(this._textArea.onBlur(() => {
			if (this._currentComposition) {
				// See https://github.com/shadowcode/shadowcode/issues/112621
	...
	private _installSelectionChangeListener(): IDisposable {
		// See https://github.com/shadowcode/shadowcode/issues/27216 and https://github.com/shadowcode/shadowcode/issues/98256
