...
export class TextAreaEditContext extends AbstractEditContext {
		...
		const textAreaInputHost: ITextAreaInputHost = {
			...
			getScreenReaderContent: (): TextAreaState => {
				if (this._accessibilitySupport === AccessibilitySupport.Disabled) {
					...
					// thousand chars
					// (https://github.com/shadowcode/shadowcode/issues/27799)
	...
	public override onCursorStateChanged(e: viewEvents.ViewCursorStateChangedEvent): boolean {
		...
		// See https://github.com/shadowcode/shadowcode/issues/165821
	...
	private _render(): void {
		if (this._visibleTextArea) {
			...
			if (startPosition && endPosition && visibleStart && visibleEnd && visibleEnd.left >= this._scrollLeft && visibleStart.left <= this._scrollLeft + this._contentWidth) {
				...
				// See https://github.com/shadowcode/shadowcode/issues/141725#issuecomment-1050670841
