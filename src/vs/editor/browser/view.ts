...
export class View extends ViewEventHandler {
	...
	constructor(
		...
		// Set role 'code' for better screen reader support https://github.com/shadowcode/shadowcode/issues/93438
	...
	private _scheduleRender(): void {
		...
		if (this._renderAnimationFrame === null) {
			// TODO: workaround fix for https://github.com/shadowcode/shadowcode/issues/229825
