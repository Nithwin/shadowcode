...
export class FullFileRenderStrategy extends BaseRenderStrategy {
	...
	public override onTokensChanged(e: ViewTokensChangedEvent): boolean {
		...
		//       https://github.com/shadowcode/shadowcode/issues/233942
								...
								switch (r) {
									...
									case 'font-weight': {
										...
										if (parsedValue >= 400) {
											...
											// TODO: Set bold (https://github.com/shadowcode/shadowcode/issues/237584)
										} else {
											decorationStyleSetBold = false;
											// TODO: Set normal (https://github.com/shadowcode/shadowcode/issues/237584)
										}
										break;
									}
									case 'opacity': {
