...
suite('Decoration Render Options', () => {
	...
	const options: IDecorationRenderOptions = {
		gutterIconPath: URI.parse('https://github.com/shadowcode/shadowcode/blob/main/resources/linux/code.png'),
	...
	test('css properties', () => {
		...
		assert(sheet.indexOf(`{background:url('${CSS.escape('https://github.com/shadowcode/shadowcode/blob/main/resources/linux/code.png')}') center center no-repeat;background-size:contain;}`) >= 0);
