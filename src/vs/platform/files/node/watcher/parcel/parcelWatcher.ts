...
export class ParcelWatcher extends BaseWatcher implements IRecursiveWatcherWithSubscribe {
	...
	private static readonly PREDEFINED_EXCLUDES: { [platform: string]: string[] } = {
		'win32': [],
		'darwin': [
			join(homedir(), 'Library', 'Containers') // Triggers access dialog from macOS 14 (https://github.com/shadowcode/shadowcode/issues/208105)
		],
		'linux': []
	};
	...
	// (https://github.com/shadowcode/shadowcode/issues/124723)
	...
	private onUnexpectedError(error: unknown, request?: IRecursiveWatchRequest): void {
		...
		// See https://github.com/shadowcode/shadowcode/issues/7950
