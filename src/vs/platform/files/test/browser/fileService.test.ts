...
suite('File Service', () => {
	...
	test('error from readFile bubbles through (https://github.com/shadowcode/shadowcode/issues/118060) - async', async () => {
		testReadErrorBubbles(true);
	});

	test('error from readFile bubbles through (https://github.com/shadowcode/shadowcode/issues/118060)', async () => {
	...
	test('readFile/readFileStream supports cancellation (https://github.com/shadowcode/shadowcode/issues/138805)', async () => {
		const service = disposables.add(new FileService(new NullLogService()));
