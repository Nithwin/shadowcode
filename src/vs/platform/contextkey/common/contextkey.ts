...
/** allow register constant context keys that are known only after startup; requires running `substituteConstants` on the context key - https://github.com/shadowcode/shadowcode/issues/174218#issuecomment-1437972127 */
