...
export class ProtocolMainService extends Disposable implements IProtocolMainService {
	...
	private readonly validExtensions = new Set(['.svg', '.png', '.jpg', '.jpeg', '.gif', '.bmp', '.webp', '.mp4', '.otf', '.ttf']); // https://github.com/shadowcode/shadowcode/issues/119384
	...
	constructor(
		...
		// - storage    : all files in global and workspace storage (https://github.com/shadowcode/shadowcode/issues/116735)
	...
	private handleResourceRequest(request: Electron.ProtocolRequest, callback: ProtocolCallback): void {
		...
		// Refs https://github.com/shadowcode/shadowcode/issues/148541#issuecomment-2670891511
