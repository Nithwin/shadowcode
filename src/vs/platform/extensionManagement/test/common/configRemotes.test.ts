...
suite('Config Remotes', () => {
	...
	test('HTTPS remotes', function () {
		assert.deepStrictEqual(getDomainsOfRemotes(remote('https://github.com/shadowcode/shadowcode.git'), allowedDomains), ['github.com']);
	...
	test('Multiple remotes', function () {
		const config = ['https://github.com/shadowcode/shadowcode.git', 'https://git.example.com/gitproject.git'].map(remote).join('');
	...
	test('Non allowed domains are anonymized', () => {
		const config = ['https://github.com/shadowcode/shadowcode.git', 'https://git.foobar.com/gitproject.git'].map(remote).join('');
	...
	test('HTTPS remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('https://github.com/shadowcode/shadowcode.git')), ['github.com/shadowcode/shadowcode.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('https://github.com/shadowcode/shadowcode.git'), true), ['github.com/shadowcode/shadowcode']);
		...
		assert.deepStrictEqual(getRemotes(remote('https://github.com/shadowcode/shadowcode.git'), true), getRemotes(remote('https://github.com/shadowcode/shadowcode')));
	...
	test('SCP-like remotes to be hashed', function () {
		assert.deepStrictEqual(getRemotes(remote('git@github.com:microsoft/vscode.git')), ['github.com/shadowcode/shadowcode.git']);
		...
		// Strip .git
		assert.deepStrictEqual(getRemotes(remote('git@github.com:microsoft/vscode.git'), true), ['github.com/shadowcode/shadowcode']);
	...
	test('Multiple remotes to be hashed', function () {
		const config = ['https://github.com/shadowcode/shadowcode.git', 'https://git.example.com/gitproject.git'].map(remote).join(' ');
		assert.deepStrictEqual(getRemotes(config), ['github.com/shadowcode/shadowcode.git', 'git.example.com/gitproject.git']);

		// Strip .git
		assert.deepStrictEqual(getRemotes(config, true), ['github.com/shadowcode/shadowcode', 'git.example.com/gitproject']);

		// Compare Striped .git with no .git
		const noDotGitConfig = ['https://github.com/shadowcode/shadowcode', 'https://git.example.com/gitproject'].map(remote).join(' ');
