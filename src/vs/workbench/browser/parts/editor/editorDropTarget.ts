...
export class EditorDropTarget extends Themable {
	...
	private onDragEnter(event: DragEvent): void {
		...
		if (
			...
			if (!containsDragType(event, DataTransfers.FILES, CodeDataTransfers.FILES, DataTransfers.RESOURCES, CodeDataTransfers.EDITORS, ...dndContributionKeys)) { // see https://github.com/shadowcode/shadowcode/issues/25789
