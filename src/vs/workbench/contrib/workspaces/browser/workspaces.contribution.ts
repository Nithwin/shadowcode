	...
	private doHandleWorkspaceFiles(folder: URI, workspaces: string[]): void {
		...
		if (workspaces.length === 1) {
			...
			this.notificationService.prompt(Severity.Info, localize(
				...
				neverShowAgain,
				priority: !this.storageService.isNew(StorageScope.WORKSPACE) ? NotificationPriority.SILENT : NotificationPriority.OPTIONAL // https://github.com/shadowcode/shadowcode/issues/125315
			});
		}
