...
CommandsRegistry.registerCommand({
	...
	handler: async (accessor, resource: URI | object) => {
		...
		if (uri && contextService.isInsideWorkspace(uri)) {
			...
			// See https://github.com/shadowcode/shadowcode/issues/227378
...
async function saveSelectedEditors(accessor: ServicesAccessor, options?: ISaveEditorsOptions): Promise<void> {
	...
	if (!editors) {
		...
		if (activeGroup.activeEditor) {
			...
			//
			// See also https://github.com/shadowcode/shadowcode/issues/4180
			// See also https://github.com/shadowcode/shadowcode/issues/106330
			// See also https://github.com/shadowcode/shadowcode/issues/190210
			if (
