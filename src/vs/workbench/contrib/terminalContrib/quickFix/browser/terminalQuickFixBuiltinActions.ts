...
export function gitCreatePr(): ITerminalQuickFixInternalOptions {
	return {
		...
		// 8:  remote:      https://github.com/shadowcode/shadowcode/pull/new/my_branch
		// 7:  remote:
		// 6:  remote: GitHub found x vulnerabilities on microsoft/vscode's default branch (...). To find out more, visit:
		// 5:  remote:      https://github.com/shadowcode/shadowcode/security/dependabot
		// 4:  remote:
		// 3:  To https://github.com/shadowcode/shadowcode
