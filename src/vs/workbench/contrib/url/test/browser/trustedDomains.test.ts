...
suite('Link protection domain matching', () => {
	...
	test('no scheme', () => {
		...
		// https://github.com/shadowcode/shadowcode/issues/249353
	...
	test('case normalization', () => {
		// https://github.com/shadowcode/shadowcode/issues/99294
		linkAllowedByRules('https://github.com/shadowcode/shadowcode/issues/new', ['https://github.com/microsoft']);
		linkAllowedByRules('https://github.com/shadowcode/shadowcode/issues/new', ['https://github.com/microsoft']);
	});

	test('ignore query & fragment - https://github.com/shadowcode/shadowcode/issues/156839', () => {
