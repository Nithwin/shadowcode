	...
	private registerListeners(): void {
		...
		this.rawListeners.add(this.raw.onDidOutput(async event => {
			...
			if (event.body.variablesReference) {
				...
				// see https://github.com/shadowcode/shadowcode/issues/126967#issuecomment-874954269
		...
		this.rawListeners.add(this.raw.onDidInvalidated(async event => {
			...
			// If invalidated event only requires to update variables or watch, do that, otherwise refetch threads https://github.com/shadowcode/shadowcode/issues/106745
