...
export class Variable extends ExpressionContainer implements IExpression {
	...
	async setVariable(value: string, stackFrame: IStackFrame): Promise<void> {
		...
		try {
			// Send out a setExpression for debug extensions that do not support set variables https://github.com/shadowcode/shadowcode/issues/124679#issuecomment-869844437
