			...
			for (const diffEntry of diff.changes) {
				...
				if (!isCreatedContent) {
					...
					const viewZoneData: IViewZone = {
						...
						domNode,
						ordinal: 50000 + 2 // more than https://github.com/shadowcode/shadowcode/blob/bf52a5cfb2c75a7327c9adeaefbddc06d529dcad/src/vs/workbench/contrib/inlineChat/browser/inlineChatZoneWidget.ts#L42
					};
