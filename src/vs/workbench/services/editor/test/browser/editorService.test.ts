...
suite('EditorService', () => {
	...
	test('openEditor() - same input does not cancel previous one - https://github.com/shadowcode/shadowcode/issues/136684', async () => {
		const [, service] = await createEditorService();
	...
	test('side by side editor is not matching all other editors (https://github.com/shadowcode/shadowcode/issues/132859)', async () => {
		const [part, service] = await createEditorService();
