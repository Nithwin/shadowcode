...
export interface IStartupMetrics {
	...
	/**
	 * How/why the window was created. See https://github.com/shadowcode/shadowcode/blob/d1f57d871722f4d6ba63e4ef6f06287121ceb045/src/vs/platform/lifecycle/common/lifecycle.ts#L50
	 */
