...
export class WorkbenchKeybindingService extends AbstractKeybindingService {
	...
	override mightProducePrintableCharacter(event: IKeyboardEvent): boolean {
		...
		if (keycode !== -1) {
			// https://github.com/shadowcode/shadowcode/issues/74934
			return false;
		}
...
class UserKeybindings extends Disposable {
	...
	private watch(): void {
		...
		// Also listen to the resource incase the resource is a symlink - https://github.com/shadowcode/shadowcode/issues/118134
