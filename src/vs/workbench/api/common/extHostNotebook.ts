					...
					return this._extHostSearch.doInternalFileSearchWithCustomCallback(query, token, (data) => {
						data.forEach(uri => {
							...
							const hasOtherMatches = otherViewTypeFileTargets.some(target => {
								...
								// https://github.com/shadowcode/shadowcode/blob/ac1631528e67637da65ec994c6dc35d73f6e33cc/src/vs/workbench/services/editor/browser/editorResolverService.ts#L359-L366
						...
						// temporary fix for https://github.com/shadowcode/shadowcode/issues/205044: don't show notebook results for remotehub repos.
						if (err.code === 'ENOENT') {
