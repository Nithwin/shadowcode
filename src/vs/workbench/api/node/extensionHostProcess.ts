...
// workaround for https://github.com/shadowcode/shadowcode/issues/85490
...
function patchProcess(allowExit: boolean) {
	...
	// on the desktop.
	// Refs https://github.com/shadowcode/shadowcode/issues/151012#issuecomment-1156593228
...
async function startExtensionHostProcess(): Promise<void> {
	...
	// setup things
	patchProcess(!!initData.environment.extensionTestsLocationURI); // to support other test frameworks like Jasmin that use process.exit (https://github.com/shadowcode/shadowcode/issues/37708)
